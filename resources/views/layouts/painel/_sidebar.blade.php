<!-- Desktop sidebar -->
<aside class="z-20 hidden w-64 overflow-y-auto bg-white dark:bg-gray-800 md:block flex-shrink-0 shadow-sm">
    <div class="py-3 text-gray-500 dark:text-gray-400">
        ...
        @include('layouts.painel._links_sidebar')
    </div>
</aside>
...
<aside class="fixed inset-y-0 z-20 flex-shrink-0 w-64 mt-14 overflow-y-auto bg-white dark:bg-gray-800 md:hidden"
