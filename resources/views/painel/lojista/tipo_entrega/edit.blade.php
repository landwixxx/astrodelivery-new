    ...
    <div class="container-fluid px-6 mx-auto grid tipo-entrega">
        ...
        <div class="w-full overflow-hidden rounded-lg ">
            ...
            <div class="card border dark:border-none bg-white">
                <div class="card-body">
                    <!-- Formulário -->
                    <form action="{{ route('painel.lojista.tipo-de-entrega.update', $deliveryType->id) }}" method="post">
                        @csrf
                        @method('PUT')
                        <div class="row dark:text-gray-200 gy-4">
                            ...
                            <div class="col-12 col-lg-4 col-xl-4 ">
                                ...
                                <input type="text"
                                    ...
                                    name="nome" id="nome" value="{{ old('nome', $deliveryType->nome) }}" required>
                                @error('nome')
                            ...
                            <div class="col-12 col-lg-4 col-xl-8 ">
                                ...
                                <input type="text"
                                    ...
                                    name="descricao" id="descricao" value="{{ old('descricao', $deliveryType->descricao) }}"
                                    maxlength="500">
                                @error('descricao')
                                    <div class="invalid-feedback ">
                                        {{ $message }}
                            ...
                            <div class="col-12 col-lg-4 col-xl-3 ">
                                ...
                                <div class="">
                                    <select class="selecionar-tipo w-100" name="tipo" required>
                                        <!-- options -->
                                        @if (old('tipo', $deliveryType->tipo))
                                            <option value="{{ old('tipo', $deliveryType->tipo) }}"></option>
                                        @endif
                                    </select>
                                </div>
                                @error('tipo')
                            ...
                            <div class="col-12 col-lg-4 col-xl-3 ">
                                ...
                                <div class="">
                                    <select class="selecionar-icon w-100" name="icone" required>
                                        <!-- options -->
                                        @if (old('icone', $deliveryType->icone))
                                            <option value="{{ old('icone', $deliveryType->icone) }}"></option>
                                        @endif
                                    </select>
                                </div>
                                @error('icone')
                            ...
                            <div class="col-12 col-lg-4 col-xl-3 ">
                                ...
                                <div class="">
                                    <select class="selecionar-esquema w-100" name="classe" required>
                                        <!-- options -->
                                        @if (old('classe', $deliveryType->classe))
                                            <option value="{{ old('classe', $deliveryType->classe) }}"></option>
                                        @endif
                                    </select>
                                </div>
                                @error('classe')
                            ...
                            <div class="col-12 col-lg-4 col-xl-3 ">
                                ...
                                <input type="text"
                                    ...
                                    name="valor" id="valor" placeholder="R$ 0,00"
                                    value="{{ session('valor', $deliveryType->valor) }}" required>
                                @error('valor')
                                    <div class="invalid-feedback ">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="col-12 col-lg-4 col-xl-3 ">
                                ...
                                <input type="text"
                                    ...
                                    value="{{ session('valor_minimo', $deliveryType->valor_minimo) }}" required>
                                @error('valor_minimo')
                                    <div class="invalid-feedback ">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="col-12 col-lg-4 col-xl-3 ">
                                ...
                                <input type="text"
                                    ...
                                    value="{{ old('tempo', $deliveryType->tempo) }}">
                                @error('tempo')
                                    <div class="invalid-feedback ">
                                        {{ $message }}
                                    </div>
                                ...
                                <div class="">
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="ativo" id="ativo-sim"
                                            value="S" required @if (old('ativo', $deliveryType->ativo) == 'S') checked @endif>
                                        <label class="form-check-label" for="ativo-sim">Sim</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="ativo" id="ativo-nao"
                                            value="N" @if (old('ativo', $deliveryType->ativo) == 'N') checked @endif>
                                ...
                                <div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="bloqueia_sem_cep"
                                            ...
                                            @if (old('bloqueia_sem_cep', $deliveryType->bloqueia_sem_cep) == 'S') checked @endif>
                                        <label class="form-check-label" for="bloquear-sim">Sim</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="bloqueia_sem_cep"
                                            id="bloquear-nao" value="N"
                                            @if (old('bloqueia_sem_cep', $deliveryType->bloqueia_sem_cep) == 'N') checked @endif>
                                    ...
                                    @foreach ($paymentMethods as $item)
                                        <label class="list-group-item my-1">
                                            <input class=" me-1" type="checkbox" name="metodos_pagamento[]"
                                                value="{{ $item->id }}"
                                                @if ($deliveryType->delivery_type_has_payment_methods()->where('payment_method_id', $item->id)->exists()) checked @endif>
                                            {{ $item->nome }}
                                        </label>
                                    @endforeach
