...
@section('title', 'Produtos com adicionais')
@section('content')
    <br>
    ...
    <div class="container-fluid px-6 mx-auto grid">
        ...
        <div class="d-flex">
            <div class="ms-auto mb-3">
                <a href="{{ route('painel.lojista.produtos-com-adicionais.create') }}">
                    <button
            ...
            <table class="w-full ">
                <thead>
                    <tr
                        ...
                        <th class="px-3 py-2">Cód. Prod</th>
                ...
                <tbody class="bg-white divide-y dark:divide-gray-700 dark:bg-gray-800">
                    ...
                    @foreach ($products as $product)
                        <tr class="text-gray-700 dark:text-gray-400">
                            <td class="px-3 py-2">
                                <div class="">
                                    <div class="mr-1 float-start me-3 mt-1">
                                        <img src='{{ $product->img_destaque }}' alt="" width="50" style="min-width: 50px">
                                    </div>
                                    <span>{{ $product->nome }}</span>
                                </div>
                            </td>
                            <td class="px-3 py-2 text-sm">{{ $product->codigo_empresa }}</td>
                            ...
                            <td class="px-3 py-2 text-sm">{{ $product->estoque }}</td>
                            ...
                            <td class=" px-3 py-2 text-sm text-truncate">
                                ...
                                <button class="btn btn-warning border-0 dark:text-gray-200 py-0 px-1 pt-1" type="button"
                                    data-modal-toggle="popup-modal-remover" id="remover" title="Remover Adicionais"
                                    onclick="document.getElementById('form-remover').action = `{{ route('painel.lojista.produtos-com-adicionais.remover-adicionais', $product->id) }}`">
                ...
                <form action="" method="post" name="form_remover_cat" id='form-remover'>
                    ...
                    <div class="p-6 text-center">
                        ...
                        <h3 class="mb-5 h5 font-normal text-gray-500 dark:text-gray-400 mt-3 fw-bold">
                            Tem certeza que deseja remover os adicionais deste produto?
                        </h3>
