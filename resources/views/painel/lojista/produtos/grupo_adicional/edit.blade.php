...
@section('title', 'Editar grupo de adicional')
@section('head')
    ...
    <div class="container-fluid px-6 mx-auto grid tipo-entrega">
        ...
        <div class="w-full overflow-hidden rounded-lg ">
            ...
            <div class="card border dark:border-none bg-white">
                <div class="card-body">
                    <!-- Formulário -->
                    <form action="{{ route('painel.lojista.grupo-adicional.update', $additionalGroup->id) }}"
                        method="post">
                        @method('PUT')
                        @csrf
                        <div class="row dark:text-gray-200 gy-4">
                            ...
                            <div class="col-12 col-lg-4 col-xl-3 ">
                                ...
                                <input type="text"
                                    ...
                                    name="nome" id="nome" value="{{ old('nome', $additionalGroup->nome) }}"
                                    required>
                                @error('nome')
                            ...
                            <div class="col-12 col-lg-8 col-xl-9">
                                ...
                                <input type="text"
                                    ...
                                    value="{{ old('descricao', $additionalGroup->descricao) }}">
                                @error('descricao')
                                    <div class="invalid-feedback ">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="col-12 col-lg-4 col-xl-3">
                                ...
                                <input type="text"
                                    ...
                                    name="adicional_qtd_min" id="adicional_qtd_min"
                                    value="{{ old('adicional_qtd_min', $additionalGroup->adicional_qtd_min) }}">
                            ...
                            <div class="col-12 col-lg-4 col-xl-3">
                                ...
                                <input type="text"
                                    ...
                                    name="adicional_qtd_max" id="adicional_qtd_max"
                                    value="{{ old('adicional_qtd_max', $additionalGroup->adicional_qtd_max) }}">
                            ...
                            <div class="col-12 col-lg-4 col-xl-3 ">
                                ...
                                <div class="">
                                    <select class="selecionar-adicional-juncao w-100" name="adicional_juncao" required>
                                        <!-- options -->
                                        <option value="{{ old('adicional_juncao', $additionalGroup->adicional_juncao) }}">
                                            {{ old('adicional_juncao', $additionalGroup->adicional_juncao) }}
                                        </option>
                                    </select>
                                </div>
                            ...
                            <div class="col-12 col-lg-4 col-xl-3">
                                ...
                                <input type="text"
                                    ...
                                    name="ordem" id="ordem" value="{{ old('ordem', $additionalGroup->ordem) }}">
                                @error('ordem')
                                    <div class="invalid-feedback ">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="col-12 col-lg-6 col-xl-5">
                                ...
                                <select class="selecionar-ondem-interna w-100" name="ordem_interna" required>
                                    <!-- options -->
                                    <option value="{{ old('ordem_interna', $additionalGroup->ordem_interna) }}">
                                        {{ old('ordem_interna', $additionalGroup->ordem_interna) }}
                                    </option>
                                </select>
                                @error('ordem_interna')
                                    <div class="invalid-feedback ">
