...
@section('content')
    ...
    <div class="container-fluid px-6 mx-auto grid dark:text-gray-200 mb-5 pb-5">
        ...
        <div class="w-full overflow-x-auto px-lg-3">
            ...
            <form id="form-pizza" action="{{ route('painel.lojista.produtos.pizza.update', $product->id) }}" method="post"
                        ...
                        <div class="col-12 col-lg-3 mb-3 ">
                            <div class=" overflow-hidden " style="max-width: 220px; max-height: 220px; min-height: 220px;">
                                <label for="img-principal" class="form-label position-relative">
                                    ...
                                    <img src="{{ $product->img_destaque }}" alt="" id="img-principal-foto"
                                        class="w-100 rounded-3 img-pizza-product-previa "
                            ...
                            <div class="row gy-3">
                                ...
                                <div class="col-12 col-lg-6 ">
                                    ...
                                    <input type="text"
                                        ...
                                        name="nome" value="{{ $product->nome }}" placeholder="" value=""
                                ...
                                <div class="col-12 col-lg-3 ">
                                    ...
                                    <input type="text"
                                        ...
                                        value="{{ old('valor_minimo', $product->valor) }}" maxlength="20" required>
                                    @error('valor_minimo')
                                ...
                                <div class="col-12 ">
                                    ...
                                    <textarea
                                        class="form-control w-full pl-3 pr-2 text-sm text-gray-700 placeholder-gray-600 bg-gray-100 border-1 dark:border-none rounded-md dark:placeholder-gray-500 dark:focus:shadow-outline-gray dark:focus:placeholder-gray-600 dark:bg-gray-700 dark:text-gray-200 focus:placeholder-gray-500 focus:bg-white focus:border-purple-300 focus:outline-none focus:shadow-outline-purple form-input "
                                        name="descricao" id="descricao" rows="3">{{ old('descricao', $product->descricao) }}</textarea>
                                    @error('descricao')
                                        <div class="small text-danger"> {{ $message }} </div>
                                    @enderror
                                </div>
                ...
                <!-- Sabores -->
                @include('painel.lojista.produtos.pizza._form_edit_sabores', compact('product'))

                <!-- Bordas -->
                @include('painel.lojista.produtos.pizza._form_edit_bordas', compact('product'))

                <div class="">
                    <button type="submit" class="btn btn-success bg-success px-5 text-uppercase ">
                        Atualizar
                    </button>
                </div>
            </form>
...
@section('scripts')
    ...
    <script>
        ...
        // masca em valores do foreach para sabores
        for (let i in document.querySelectorAll('.valor-sabor')) {
            let idEl = document.querySelectorAll('.valor-sabor')[i].id
            maskValor(idEl);
        }
        // masca em valores do foreach para bordas
        for (let i in document.querySelectorAll('.valor-borda')) {
            let idEl = document.querySelectorAll('.valor-borda')[i].id
            maskValor(idEl);
        }
    </script>
    <script>
