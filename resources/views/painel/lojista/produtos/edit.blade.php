...
@section('content')
    ...
    <div class="container-fluid px-6 mx-auto grid mb-5 pb-5">
        ...
        <div class="card border dark:border-none bg-white">
            <div class="card-body">
                <!-- Formulario -->
                <form action="{{ route('painel.lojista.produtos.update', $product->id) }}" method="post"
                    ...
                    <div class="row dark:text-gray-200">
                        ...
                        <div class="col-12 col-lg-2 col-xl-2 mb-3">
                            ...
                            <select
                                ...
                                <option value="PRODUTO" @if (old('tipo', $product->tipo) == 'PRODUTO') selected @endif>PRODUTO</option>
                                <option value="ADICIONAL" @if (old('tipo', $product->tipo) == 'ADICIONAL') selected @endif>ADICIONAL
                                </option>
                                <option value="PIZZA" @if (old('tipo', $product->tipo) == 'PIZZA') selected @endif>PIZZA</option>
                            </select>
                            @error('tipo')
                        ...
                        <div class="col-12 col-lg-5 col-xl-5 mb-3">
                            ...
                            <input type="text"
                                ...
                                name="nome" value="{{ old('nome', $product->nome) }}" id="nome" required>
                            @error('nome')
                                <div class="invalid-feedback fw-bold">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="col-12 col-lg-3 col-xl-3 mb-3">
                            ...
                            <input type="text"
                                ...
                                name="sub_nome" value="{{ old('sub_nome', $product->sub_nome) }}" id="sub_nome" required>
                            @error('sub_nome')
                                <div class="invalid-feedback fw-bold">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="col-12 col-lg-2 col-xl-2 mb-3">
                            ...
                            <input type="color"
                                ...
                                name="cor_sub_nome" value="{{ old('cor_sub_nome', $product->cor_sub_nome) }}"
                                id="cor_sub_nome" required>
                            @error('cor_sub_nome')
                                <div class="invalid-feedback fw-bold">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="col-12 col-lg-12 col-xl-12 mb-3">
                            ...
                            <textarea
                                ...
                                name="descricao" id="descricao" rows="3" maxlength="2000">{{ old('descricao', $product->descricao) }}</textarea>
                            @error('descricao')
                                <div class="invalid-feedback fw-bold">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="col-12 col-lg-3 col-xl-3 mb-3">
                            ...
                            <input type="text"
                                ...
                                name="codigo_empresa" id="codigo_empresa"
                                value="{{ old('codigo_empresa', $product->codigo_empresa) }}" maxlength="255">
                        ...
                        <div class="col-12 col-lg-6 col-xl-6 mb-3">
                            ...
                            <input type="text"
                                ...
                                name="codigo_barras" value="{{ old('codigo_barras', $product->codigo_barras) }}"
                                id="codigo_barras" placeholder="" maxlength="255">
                            @error('codigo_barras')
                                <div class="invalid-feedback fw-bold">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="col-12 col-lg-3 col-xl-3 mb-3">
                            ...
                            <select
                                ...
                                <option value="TYPE_EAN_13" @if (old('codigo_barras_padrao', $product->codigo_barras_padrao) == 'TYPE_EAN_13') selected @endif>
                                    TYPE_EAN_13
                                </option>
                                <option value="TYPE_CODE_128" @if (old('codigo_barras_padrao', $product->codigo_barras_padrao) == 'TYPE_CODE_128') selected @endif>
                                    ADICIONAL
                                </option>
                                <option value="TYPE_CODE_39" @if (old('codigo_barras_padrao', $product->codigo_barras_padrao) == 'TYPE_CODE_39') selected @endif>
                                    TYPE_CODE_39
                                </option>
                                <option value="TYPE_INTERLEAVED_2_5" @if (old('codigo_barras_padrao', $product->codigo_barras_padrao) == 'TYPE_INTERLEAVED_2_5') selected @endif>
                                    TYPE_INTERLEAVED_2_5
                                </option>
                                <option value="TYPE_EAN_8" @if (old('codigo_barras_padrao', $product->codigo_barras_padrao) == 'TYPE_EAN_8') selected @endif>
                                    TYPE_EAN_8
                                </option>
                            </select>
                        ...
                        <div class="col-12 col-lg-2 col-xl-2 mb-3">
                            <label for="valor_original" class="form-label fw-500">
                                Valor Original<span class="text-danger">*</span>
                            ...
                            <input type="text"
                                ...
                                name="valor_original" id="valor_original"
                                value="{{ old('valor_original', $product->valor_original) }}" placeholder="0,00"
                                required>
                        ...
                        <div class="col-12 col-lg-2 col-xl-2 mb-3">
                            ...
                            <input type="text"
                                ...
                                name="valor" id="valor" value="{{ old('valor', $product->valor) }}"
                                placeholder="0,00">
                            @error('valor')
                                <div class="invalid-feedback fw-bold">
                                    {{ $message }}
                        ...
                        <div class="col-12 col-lg-2 col-xl-2 mb-3">
                            ...
                            <input type="text"
                                ...
                                name="estoque" value="{{ old('estoque', $product->estoque) }}" id="estoque">
                            @error('estoque')
                                <div class="invalid-feedback fw-bold">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="col-12 col-lg-2 col-xl-2 mb-3">
                            ...
                            <input type="text"
                                ...
                                name="ordem" value="{{ old('ordem', $product->ordem) }}" id="ordem">
                            @error('ordem')
                                <div class="invalid-feedback fw-bold">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="col-12 col-lg-3 col-xl-3 mb-3">
                            ...
                            <select
                                ...
                                <option value="" selected>Selecione</option>
                                <option value="S" @if (old('limitar_estoque', $product->limitar_estoque) == 'S') selected @endif>SIM</option>
                                <option value="N" @if (old('limitar_estoque', $product->limitar_estoque) == 'N') selected @endif>NAO</option>
                            </select>
                        ...
                        <div class="col-12 col-lg-3 col-xl-3 mb-3">
                            ...
                            <select
                                ...
                                <option value="S" @if (old('fracao', $product->fracao) == 'S') selected @endif>SIM</option>
                            </select>
                            @error('fracao')
                                <div class="invalid-feedback fw-bold">
                                    {{ $message }}
                        ...
                        <div class="col-12 col-lg-3 col-xl-3 mb-3" id='col-item_adicional'
                            ...
                            <select
                                ...
                                name="item_adicional" id="item_adicional" required>
                                <option value="S" @if (old('item_adicional', $product->item_adicional) == 'S') selected @endif>SIM</option>
                                <option value="N" @if (old('item_adicional', $product->item_adicional) == 'N') selected @endif>NAO</option>
                            </select>
                        ...
                        <div class="col-12 col-lg-3 col-xl-3 mb-3" id="div-item_adicional_obrigar"
                            ...
                            <select
                                ...
                                <option value="N" @if (old('item_adicional_obrigar', $product->item_adicional_obrigar) == 'N') selected @endif>NAO</option>
                                <option value="S" @if (old('item_adicional_obrigar', $product->item_adicional_obrigar) == 'S') selected @endif>SIM</option>
                            </select>
                        ...
                        <div class="col-12 col-lg-3 col-xl-3 mb-3" id="div-item_adicional_multi"
                            ...
                            <select
                                ...
                                <option value="N" @if (old('item_adicional_multi', $product->item_adicional_multi) == 'N') selected @endif>NAO</option>
                                <option value="S" @if (old('item_adicional_multi', $product->item_adicional_multi) == 'S') selected @endif>SIM</option>
                            </select>
                        ...
                        <div class="col-12 col-lg-3 col-xl-3 mb-3" id="div-adicional_qtde_min"
                            ...
                            <input type="text"
                                ...
                                name="adicional_qtde_min"
                                value="{{ old('adicional_qtde_min', $product->adicional_qtde_min) }}"
                        ...
                        <div class="col-12 col-lg-3 col-xl-3 mb-3" id="div-adicional_qtde_max"
                            ...
                            <input type="text"
                                ...
                                name="adicional_qtde_max"
                                value="{{ old('adicional_qtde_max', $product->adicional_qtde_max) }}"
                        ...
                        <div class="col-12 col-lg-3 col-xl-3 mb-3" id="div-adicional_juncao"
                            ...
                            <select
                                ...
                                <option value="SOMA" @if (old('adicional_juncao', $product->adicional_juncao) == 'SOMA') selected @endif>SOMA</option>
                                <option value="DIVIDIR" @if (old('adicional_juncao', $product->adicional_juncao) == 'DIVIDIR') selected @endif>DIVIDIR
                                </option>
                                <option value="MEDIA" @if (old('adicional_juncao', $product->adicional_juncao) == 'MEDIA') selected @endif>MEDIA</option>
                            </select>
                        ...
                        <div class="col-12 col-lg-3 col-xl-3 mb-3" id="div-grupo-adicional"
                            style="@if (old('tipo', $product->tipo) == 'ADICIONAL') display:block; @else display:none @endif">
                            ...
                            <select
                                ...
                                @if (old('tipo', $product->tipo) == 'ADICIONAL') required @endif>
                                <option value="" selected>Selecione</option>
                                @foreach ($additional_groups as $additional_group)
                                    <option value="{{ $additional_group->id }}"
                                        @if (old('grupo_adicional_id', $product->grupo_adicional_id) == $additional_group->id) selected @endif>
                        ...
                        <div class="col-12">
                            <h2 class="h5 fw-bold mb-0">Imagem do produto</h2>
                            <p class="small text-muted mb-3">
                                *Ao salvar as alterações, a imagem principal será sempre a primeira
                            </p>
                            <!-- Imgs cadastrados -->
                                ...
                                @foreach ($product->images as $img)
                                    <div class="col-6 col-sm-3 col-lg-2 ">
                                        <div class="position-relative">
                                            <button type="button"
                                                class="btn btn-danger position-absolute bg-danger p-0 px-1 rounded-0"
                                                title="Remover" style="top: 0; right: 0px"
                                                onclick="removeImage('{{ $img->id }}');this.parentNode.parentNode.remove();">
                                                &times;
                                            </button>
                                            <img src="{{ $img->foto }}" alt="" class="w-100">
                                        </div>
                                    </div>
                                @endforeach

                                <!-- inputs para remoção de imanges -->
                                <div class="" id="inputs-img-removidas">
                                    <!-- imganes removidas -->
                                </div>
                            </div>

                            <div class="form-group overflow-hidden" id="file_imagem">
...
@section('scripts')
    ...
    <script>
        ...
        /* remover imanges */
        function removeImage(produto_id) {
            console.log(produto_id)
            let el_imgs_removidas = document.querySelector('#inputs-img-removidas')
            el_imgs_removidas.innerHTML += `
            <input type="hidden" name="imgs_removidas_id[]" value="${produto_id}">`
        }
    </script>
    ...
    <script>
        ...
        document.getElementById('tipo').onchange = function() {
            ...
            if (selectedOption == 'PIZZA') {
                window.location.href = `{{ route('painel.lojista.produtos.pizza.edit', $product->id) }}`;
            }
        }
    </script>
    <script>
