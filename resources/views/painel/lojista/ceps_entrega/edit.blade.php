...
@section('title', 'Editar CEP de entrega')
@section('head')
    ...
    <div class="container-fluid px-6 mx-auto grid tipo-entrega">
        ...
        <div class="w-full overflow-hidden rounded-lg ">
            ...
            <div class="card border dark:border-none bg-white">
                <div class="card-body">
                    <!-- Formulário -->
                    <form action="{{ route('painel.lojista.ceps-de-entrega.update', $deliveryZipCode->id) }}" method="post">
                        @method('PUT')
                        @csrf
                        <div class="row dark:text-gray-200 gy-4">
                            ...
                            <div class="col-12 col-lg-4 col-xl-3 ">
                                ...
                                <input type="text"
                                    ...
                                    name="nome" id="nome" value="{{ old('nome', $deliveryZipCode->nome) }}"
                                    required>
                                @error('nome')
                            ...
                            <div class="col-12 col-lg-4 col-xl-3 ">
                                ...
                                <div class="">
                                    <select class="selecionar-tipo w-100" name="tipo_entrega_id" required>
                                        <!-- options -->
                                        @if (old('tipo_entrega_id', $deliveryZipCode->tipo_entrega_id))
                                            <option value="{{ old('tipo_entrega_id', $deliveryZipCode->tipo_entrega_id) }}">
                            ...
                            <div class="col-12 col-lg-4 col-xl-3 ">
                                ...
                                <input type="text"
                                    ...
                                    name="cep_ini" id="cep_ini" value="{{ old('cep_ini', $deliveryZipCode->cep_ini) }}"
                            ...
                            <div class="col-12 col-lg-4 col-xl-3 ">
                                ...
                                <input type="text"
                                    ...
                                    name="cep_fim" id="cep_fim" value="{{ old('cep_fim', $deliveryZipCode->cep_fim) }}"
                                    placeholder="00000-000" required>
                                @error('cep_fim')
                                    <div class="invalid-feedback ">
                                        {{ $message }}
                            ...
                            <div class="col-12 col-lg-4 col-xl-3 ">
                                ...
                                <input type="text"
                                    ...
                                    value="{{ session('valor', $deliveryZipCode->valor) }}" required>
                                @error('valor')
                                    <div class="invalid-feedback ">
                                        {{ $message }}
                                    </div>
                                ...
                                <div class="">
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="status" id="status-ativo"
                                            value="ativo" required @if (old('status', $deliveryZipCode->status) == 'ativo') checked @endif>
                                    ...
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="status" id="status-desativado"
                                            value="desativado" @if (old('status', $deliveryZipCode->status) == 'desativado') checked @endif>
