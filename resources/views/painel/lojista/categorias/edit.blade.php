    ...
    <div class="container px-6 mx-auto grid mb-5 pb-4">
        ...
        <div class="container px-0 mx-auto grid mb-5">
            ...
            <div class="w-full overflow-hidden rounded-lg ">
                <h1 class="h4 fw-bold text-gray-600 dark:text-gray-200 mb-2">Editar Categoria</h1>

                <div class="card border dark:border-none bg-white">
                    <div class="card-body">
                        <!-- Formulário -->
                        <form action="{{ route('painel.lojista.categorias.update', $category->id) }}" method="post"
                                ...
                                <div class="row gy-4 ">
                                    ...
                                    <div class=" col-12 col-lg-4 dark:text-gray-200 ">
                                        ...
                                        <div class="d-flex  gap-2">
                                            <img src="{{ is_null($category->foto) ? asset('assets/img/img-prod-vazio.png') : $category->foto }}"
                                                alt="" width="100" id="img-previa">
                                            <div class="">
                                                <input type="file" name="foto" id="foto"
                                                    accept=".jpg,.jpeg,.png,.gif,.bmp,.webp" class="w-100">
                                    ...
                                    <label class="block col-12 col-lg-3">
                                        ...
                                        <input name="nome" id="nome" value="{{ old('nome', $category->nome) }}"
                                    ...
                                    <div class="col-12 col-lg-3">
                                        ...
                                        <select
                                            ...
                                            <option value="S" @if (old('ativo', $category->ativo) == 'S') selected @endif> Sim
                                            </option>
                                            <option value="N" @if (old('ativo', $category->ativo) == 'N') selected @endif> Não
                                            </option>
                                        </select>
                                        @error('ativo')
                                    ...
                                    <div class="col-12 col-lg-4 col-xl-4 mb-3">
                                        <label for="slug" class="form-label fw-500 dark:text-gray-200">
                                            Slug URL
                                        </label>
                                        <input type="text"
                                            class="form-control @error('slug') is-invalid @enderror w-full pl-3 pr-2 text-sm text-gray-700 placeholder-gray-600 bg-gray-100 border-1 dark:border-none rounded-md dark:placeholder-gray-500 dark:focus:shadow-outline-gray dark:focus:placeholder-gray-600 dark:bg-gray-700 dark:text-gray-200 focus:placeholder-gray-500 focus:bg-white focus:border-purple-300 focus:outline-none focus:shadow-outline-purple form-input"
                                    ...
                                    <!-- Descrição -->
                                    <label class="block mt-4 col-12 col-lg-8">
                                        ...
                                        <textarea name="descricao"
                                            ...
                                            rows="3" placeholder="">{{ old('descricao', $category->descricao) }}</textarea>
                                        @error('descricao')
                                            <div class="invalid-feedback bold">{{ $message }}</div>
                                        @enderror
                                    </label>
                                    ...
                                    <div class="col-12">
                                        <button type="submit" class="btn btn-primary bg-primary">Atualizar</button>
                                    </div>
