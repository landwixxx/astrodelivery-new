    ...
    <div class="container-fluid px-6 mx-auto grid dark:text-gray-200 mb-5 pb-5">
        ...
        <div class="w-full overflow-x-auto px-4 py-3 mb-8 bg-white rounded-lg shadow-md dark:bg-gray-800">
            ...
            <div class="text-end mb-3">
                <a href="{{ route('painel.lojista.entrega-mesa.create') }}">
                    <button
            ...
            <div class="w-full overflow-x-auto ">
                <table class="w-full whitespace-no-wrap">
                    ...
                    <tbody class="bg-white divide-y dark:divide-gray-700 dark:bg-gray-800">
                        ...
                        @endif
                        @foreach ($deliveryTables as $deliveryTable)
                            <tr class="text-gray-700 dark:text-gray-400">
                                <td scope="row" class=" px-1 py-2">
                                    {{ $deliveryTable->mesa }}
                                </td>
                                <td scope="row" class=" px-1 py-2">
                                    {{ $deliveryTable->delivery_type->nome }}
                                </td>
                                <td scope="row" class=" px-1 py-2">
                                    {{ Str::limit($deliveryTable->descricao, 100) ?? '-' }}
                                </td>
                                <td class=" px-1 py-2">
                                    @if ($deliveryTable->status == 'ativo')
                                ...
                                <td class=" px-1 py-2">
                                    ...
                                    <a type="button"
                                        href="{{ route('painel.lojista.entrega-mesa.edit', $deliveryTable->id) }}"
                                    ...
                                    <button class="btn btn-light border-0 dark:text-gray-200 py-0 px-1 pt-1" type="button"
                                        ...
                                        onclick="document.getElementById('form-remover').action = `{{ route('painel.lojista.entrega-mesa.destroy', $deliveryTable->id) }}`">
