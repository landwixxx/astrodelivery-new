...
@section('title', 'Cadastrar entrega mesa')
@section('head')
    ...
    <div class="container-fluid px-6 mx-auto grid tipo-entrega">
        ...
        <div class="w-full overflow-hidden rounded-lg ">
            ...
            <div class="card border dark:border-none bg-white">
                <div class="card-body">
                    <!-- Formulário -->
                    <form action="{{ route('painel.lojista.entrega-mesa.store') }}" method="post">
                        @csrf
                        <div class="row dark:text-gray-200 gy-4">
                            ...
                            <div class="col-12 col-lg-4 col-xl-3 ">
                                ...
                                <input type="text"
                                    ...
                                    name="mesa" id="mesa" value="{{ old('mesa') }}" required>
                                @error('mesa')
                                    <div class="invalid-feedback ">
                                        {{ $message }}
                                    </div>
