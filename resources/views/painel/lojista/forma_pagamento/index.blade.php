    ...
    <div class="container-fluid px-6 mx-auto grid dark:text-gray-200 mb-5 pb-5">
        ...
        <div class="w-full overflow-x-auto px-4 py-3 mb-8 bg-white rounded-lg shadow-md dark:bg-gray-800">
            ...
            <div class="text-end mb-3">
                <a href="{{ route('painel.lojista.forma-de-pagamento.create') }}">
                    <button
                        ...
                        @foreach ($paymentMethods as $paymentMethod)
                            <tr class="text-gray-700 dark:text-gray-400">
                                ...
                                <td class="px-1 py-2 text-truncate" style="max-width: 300px">
                                    {{ Str::limit($paymentMethod->descricao, 100) ?? '-' }}
                                </td>
                                <td class="px-1 py-2">{{ $paymentMethod->tipo }}</td>
                                <td class=" px-1 py-2">
                                    @if ($paymentMethod->ativo == 'S')
                                ...
                                <td class=" px-1 py-2">
                                    ...
                                    <a type="button"
                                        href="{{ route('painel.lojista.forma-de-pagamento.edit', $paymentMethod->id) }}"
                                    ...
                                    <button class="btn btn-light border-0 dark:text-gray-200 py-0 px-1 pt-1" type="button"
                                        ...
                                        onclick="document.getElementById('form-remover').action = `{{ route('painel.lojista.forma-de-pagamento.destroy', $paymentMethod->id) }}`">
