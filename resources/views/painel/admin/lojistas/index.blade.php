...
@section('content')
    ...
    <div class=" px-4 pesquisa gap-3 flex-column flex-lg-row  flex justify-center flex-1 lg:mr-32 ">
        <div class=" order-2 order-lg-1 relative w-full max-w-xl mr-6 focus-within:text-purple-500">
            ...
            <form action="{{ route('painel.admin.lojistas.index') }}">
                <input
        ...
        <div class="text-end order-1 order-lg-2">
            <a class="" href="{{ route('painel.admin.lojistas.create') }}"><button
                    ...
                    <tbody class="bg-white divide-y dark:divide-gray-700 dark:bg-gray-800">
                        ...
                        @foreach ($shopkeepers as $shopkeeper)
                            <tr class="text-gray-700 dark:text-gray-400">
                                ...
                                <td class=" px-3 py-3 text-sm" style="">
                                    @if ($shopkeeper->profile == 'lojista')
                                ...
                                <td class=" px-3 py-2 text-sm">
                                    ...
                                    <a type="button" href="{{ route('painel.admin.lojistas.edit', $shopkeeper->id) }}"
                                    ...
                                    @if ($shopkeeper->status != 'ativo')
                                        <a type="button"
                                            href="{{ route('painel.admin.lojistas.ativar', $shopkeeper->id) }}"
                                    ...
                                    @else
                                        <a type="button"
                                            href="{{ route('painel.admin.lojistas.desativar', $shopkeeper->id) }}"
                                    ...
                                    <button class="btn btn-light border-0 dark:text-gray-200 py-0 px-1 pt-1" type="button"
                                        data-modal-toggle="popup-modal-negar" title="Remover"
                                        onclick="document.getElementById('form-remover').action = `{{ route('painel.admin.lojistas.destroy', $shopkeeper->id) }}`">
