...
@section('title', 'Cadastrar Lojista')
@section('content')
    <br>
    ...
    <div class="container-fluid px-6 mx-auto grid">
        ...
        <div class="w-full overflow-hidden rounded-lg ">
            <h1 class="h4 fw-bold text-gray-600 dark:text-gray-200 mb-4">Cadastrar Lojista</h1>

            <div class="card border dark:border-none bg-white">
                <div class="card-body">
                    <!-- Formulário -->
                    <form action="{{ route('painel.admin.lojistas.store') }}" method="post">
                        @csrf
                        <div class="row dark:text-gray-200">
                            ...
                            <div class="col-12 col-lg-4 col-xl-4 mb-3">
                                ...
                                <input type="text"
                                    ...
                                    name="phone" id="phone" placeholder="(00) 00000-0000" value="{{ old('phone') }}"
                                    required>
                                @error('phone')
                                    <div class="invalid-feedback fw-bold">
                                        {{ $message }}
